...
def get_filters():
    ...
    while True:
        city = input("which city what you want ??").lower()
        if city in cities:
            break
        else:
    ...
    while True:
        day_selected = input("which day ??").lower()
...
def display_raw_data(df):
    ...
    print("The raw data is available now if you want to check them ")
    index = 0
    raw_data_input = input("if you want to see first five rows of this data please enter yes and if you want nothing please enter no: ").lower()
    if raw_data_input != "yes":
        print("thank you very much, and good bye")
    else:
        while index +5 < df.shape[0]:
            print(df.iloc[index : index +5])
            index += 5
            raw_data_input = input("You want another five rows ??, please enter yes or no: ").lower()
            if raw_data_input != "yes":
                print("thank you very much, and good bye")
                break
